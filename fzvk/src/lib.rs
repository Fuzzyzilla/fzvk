...
mod macro_use {
    ...
    /// [`PhantomData`](super::PhantomData), and implements
...
pub unsafe trait ThinHandle: Sized {
    ...
    /// [`Buffer::as_subusage`] just as an example:)
    /// ```no_run
    /// # use fzvk::*;
...
impl<'device> Device<'device> {
    ...
    pub unsafe fn create_command_pool(
        ...
        self.0
            ...
            .map(|handle| CommandPool::from_handle(handle))
            .map_err(AllocationError::from_vk)
    }
    ...
    pub unsafe fn begin_command_buffer<'a, Level: CommandBufferLevel>(
        ...
        self.0
            ...
            .map_err(AllocationError::from_vk)?;
        Ok(RecordingBuffer::from_handle(buffer.handle()))
    }
